...
// get the rectangle for computing the descriptor emmmm, just it.
...
// compute integral histograms for the whole image. dp[i][j] 左上角的矩形
...
{
	Mat imgX, imgY;
	Sobel(img, imgX, CV_32F, 1, 0, 1); // x方向求导
	Sobel(img, imgY, CV_32F, 0, 1, 1); // y方向求导
